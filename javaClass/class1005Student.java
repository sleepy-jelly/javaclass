...
public class class1005Student {
	...
	private int[] stuNum= new int[MAX];
	...
	protected void getFullByString(int pointer) {
		sb.append("학번: "+Integer.toString(stuNum[pointer])+" ");
		...
		getAvg(pointer);
		sb.append("평균: "+Double.toString(Math.round(avg[pointer]*100)/100)+" ");
		getSum(pointer);
